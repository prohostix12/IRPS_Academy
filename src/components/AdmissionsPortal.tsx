...
import { INITIAL_APPLICATIONS, UNIVERSITIES, PROGRAMS } from '../data/universityData';
...
export const AdmissionsPortal: React.FC<AdmissionsPortalProps> = ({ 
  ...
  const [formData, setFormData] = useState({
    ...
    degreeLevel: preselectedProgram ? preselectedProgram.degreeLevel : 'Undergraduate',
    gpa: '3.80',
    satGreScore: '1450',
    statementOfPurpose: '',
    ...
    <div className="py-16 bg-[#FAF6F6] min-h-screen">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex justify-center mb-10">
          <div className="bg-white p-1.5 rounded-2xl shadow-md border border-[#7A0016]/15 flex flex-wrap gap-1 max-w-2xl w-full">
            <button
              ...
              className={`flex-1 min-w-[140px] py-3 px-4 rounded-xl text-xs sm:text-sm font-bold transition-all flex items-center justify-center gap-2 cursor-pointer ${
                activeSubTab === 'apply'
                  ...
                  : 'text-neutral-700 hover:text-[#7A0016] hover:bg-[#7A0016]/10'
              }`}
            >
          ...
          <div className="max-w-4xl mx-auto bg-white rounded-3xl p-6 sm:p-10 shadow-xl border border-neutral-200">
            ...
            {submittedAppId ? (
              <div className="text-center py-10 space-y-6 animate-fadeIn">
                ...
                <h3 className="text-3xl font-bold font-serif text-[#4A000E]">
                ...
                <div className="bg-[#FAF6F6] p-6 rounded-2xl border border-[#7A0016]/20 max-w-sm mx-auto">
                  <span className="text-xs font-bold text-neutral-500 uppercase block mb-1">Your Tracking Reference ID</span>
                  <span className="text-2xl font-black text-[#7A0016] font-mono tracking-wider">{submittedAppId}</span>
                </div>
                ...
                <div className="flex flex-wrap justify-center gap-3 pt-4">
                  <button
                    ...
                    className="px-6 py-3 bg-[#7A0016] text-white font-bold text-sm rounded-xl shadow-md hover:bg-[#600010]"
                  >
                    Track Status Now
                  </button>
                  <button
              ...
              <div>
                ...
                <div className="mb-8">
                  <div className="flex items-center justify-between text-xs font-bold text-neutral-500 mb-2">
                    <span className={wizardStep >= 1 ? 'text-[#7A0016]' : ''}>1. Applicant Profile</span>
                    <span className={wizardStep >= 2 ? 'text-[#7A0016]' : ''}>2. University & Program</span>
                    <span className={wizardStep >= 3 ? 'text-[#7A0016]' : ''}>3. Academics & Docs</span>
                    <span className={wizardStep >= 4 ? 'text-[#7A0016]' : ''}>4. Review & Submit</span>
                  </div>

                  <div className="w-full bg-neutral-200 h-2 rounded-full overflow-hidden">
                    <div 
                      className="bg-[#7A0016] h-full transition-all duration-300"
                ...
                <form onSubmit={handleApplicationSubmit}>
                    ...
                    <div className="space-y-5 animate-fadeIn">
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        <div>
                          ...
                          <select className="w-full bg-neutral-50 border border-neutral-300 rounded-xl px-4 py-2.5 text-sm focus:ring-2 focus:ring-[#7A0016] outline-none">
                      ...
                      <div className="pt-4 flex justify-end">
                        <button
                          ...
                          className="px-6 py-3 bg-[#7A0016] text-white font-bold text-xs rounded-xl shadow-md hover:bg-[#600010] flex items-center gap-2"
                        >
                  ...
                  {wizardStep === 2 && (
                    <div className="space-y-5 animate-fadeIn">
                      ...
                      <div className="grid grid-cols-1 gap-4">
                        <div>
                          ...
                          <select
                            ...
                            className="w-full bg-neutral-50 border border-neutral-300 rounded-xl px-4 py-3 text-sm font-semibold text-neutral-800 focus:ring-2 focus:ring-[#7A0016] outline-none cursor-pointer"
                          >
                            {UNIVERSITIES.map(u => (
                          ...
                          <select
                            ...
                            onChange={(e) => {
                              ...
                              setFormData({
                                ...formData,
                                programTitle: title,
                                degreeLevel: p ? p.degreeLevel : 'Undergraduate'
                              });
                            }}
                            className="w-full bg-neutral-50 border border-neutral-300 rounded-xl px-4 py-3 text-sm font-semibold text-neutral-800 focus:ring-2 focus:ring-[#7A0016] outline-none cursor-pointer"
                          >
                      ...
                      <div className="p-4 bg-[#FAF6F6] rounded-xl border border-[#7A0016]/10 text-xs text-neutral-700 flex items-center justify-between">
                        <div>
                          <span className="font-bold text-[#7A0016] block">Selected Degree Tier:</span>
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="p-4 bg-neutral-50 rounded-xl border border-dashed border-neutral-300 flex items-center justify-between">
                          <div className="flex items-center gap-3">
                            <FileCheck className="w-5 h-5 text-[#7A0016]" />
                            <div>
                  ...
                  {wizardStep === 4 && (
                    <div className="space-y-5 animate-fadeIn">
                      ...
                      <div className="bg-[#FAF6F6] rounded-2xl p-5 border border-[#7A0016]/20 space-y-3 text-xs text-neutral-800">
                        ...
                        <div className="flex justify-between border-b border-neutral-200 pb-2">
                          ...
                          <span className="font-bold text-[#7A0016]">{formData.universityName}</span>
                        </div>
                        <div className="flex justify-between border-b border-neutral-200 pb-2">
                          <span className="font-semibold text-neutral-500">Target Program:</span>
                          <span className="font-bold text-[#7A0016]">{formData.programTitle}</span>
                        </div>
                      ...
                      <div className="pt-4 flex justify-between">
                        ...
                        <button
                          type="submit"
                          className="px-8 py-3.5 bg-[#7A0016] text-white font-bold text-sm rounded-xl shadow-lg hover:bg-[#600010] transition-all flex items-center gap-2 cursor-pointer"
                        >
        ...
        {activeSubTab === 'track' && (
          <div className="max-w-4xl mx-auto space-y-8 animate-fadeIn">
            ...
            <div className="bg-white rounded-3xl p-6 sm:p-8 shadow-xl border border-neutral-200">
              <h3 className="text-xl font-bold font-serif text-[#4A000E] mb-2">
              ...
              <form onSubmit={handleTrackSearch} className="flex flex-col sm:flex-row gap-3">
                <input
                  ...
                  className="flex-grow bg-neutral-50 border border-neutral-300 rounded-xl px-4 py-3 text-sm font-mono font-bold text-neutral-800 focus:ring-2 focus:ring-[#7A0016] outline-none"
                />
                <button
                  type="submit"
                  className="py-3 px-6 bg-[#7A0016] hover:bg-[#600010] text-white font-bold text-xs rounded-xl shadow-md transition-all flex items-center justify-center gap-2"
                >
              ...
              {searchError && (
                <p className="mt-3 text-xs font-semibold text-red-600 bg-red-50 p-3 rounded-lg border border-red-200">
                  {searchError}
                </p>
              )}
            </div>
              ...
              <div className="bg-white rounded-3xl p-6 sm:p-8 shadow-xl border border-neutral-200 space-y-6">
                ...
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2 border-b border-neutral-200 pb-4">
                  <div>
                    ...
                    <h4 className="text-2xl font-bold font-serif text-[#4A000E] mt-0.5">
                ...
                {/* Target Info Grid */}
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 bg-[#FAF6F6] p-4 rounded-2xl border border-[#7A0016]/10 text-xs">
                  <div>
                    <span className="text-neutral-500 block font-medium">University</span>
                    <span className="font-bold text-[#7A0016] text-sm">{trackedRecord.universityName}</span>
                  </div>
                  <div>
                    <span className="text-neutral-500 block font-medium">Program</span>
                    <span className="font-bold text-[#7A0016] text-sm">{trackedRecord.programTitle}</span>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-4 gap-3 text-center text-xs">
                    ...
                    <div className={`p-3 rounded-xl border font-bold space-y-1 ${
                      ...
                      <Award className="w-5 h-5 mx-auto text-[#7A0016]" />
        ...
        {activeSubTab === 'calculator' && (
          <div className="max-w-4xl mx-auto bg-white rounded-3xl p-6 sm:p-10 shadow-xl border border-neutral-200 animate-fadeIn space-y-8">
            ...
            <div className="border-b border-neutral-200 pb-4">
              <h3 className="text-2xl font-bold font-serif text-[#4A000E] flex items-center gap-2">
                <Calculator className="w-6 h-6 text-[#7A0016]" />
                <span>Scholarship & Financial Aid Calculator</span>
              </h3>
              <p className="text-xs text-neutral-600 mt-1">
                Estimate your merit grant award based on high school or undergraduate GPA, standardized test scores, and leadership achievements.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
              ...
              <div className="space-y-5">
                ...
                <div>
                  <div className="flex justify-between text-xs font-bold text-neutral-700 mb-1">
                    ...
                    <span className="text-[#7A0016] text-sm">{calcGpa.toFixed(2)} / 4.0</span>
                  </div>
                  <input
                    type="range"
                    min="2.5"
                    ...
                    className="w-full accent-[#7A0016] cursor-pointer"
                  />
                </div>
                ...
                <div>
                  <div className="flex justify-between text-xs font-bold text-neutral-700 mb-1">
                    ...
                    <span className="text-[#7A0016] text-sm">{calcScore} Points</span>
                  </div>
                  <input
                    type="range"
                    min="1000"
              ...
              <div className="bg-gradient-to-br from-[#7A0016] to-[#4A000E] text-white p-8 rounded-2xl shadow-xl text-center space-y-4 relative overflow-hidden">
                ...
                <button
                  onClick={() => setActiveSubTab('apply')}
                  className="mt-2 w-full py-3 bg-white text-[#7A0016] font-bold text-xs rounded-xl shadow-md hover:bg-red-50 transition-colors"
                >
