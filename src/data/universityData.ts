...
export const PROGRAMS: Program[] = [
  {
    ...
    featured: true,
    description: 'A rigorous core in algorithm analysis, distributed cloud systems, cybersecurity, full-stack architecture, and machine learning principles with industry capstones.',
    curriculumHighlights: ['Data Structures & Algorithms', 'Cloud Architecture & DevOps', 'Cybersecurity & Cryptography', 'AI & Machine Learning Foundations'],
    careerOutcomes: ['Software Architect', 'Cloud Solutions Engineer', 'Full-Stack Developer', 'DevOps Lead'],
    prerequisites: 'High School Diploma with High Honors in Mathematics (Calculus) and Physics. Minimum GPA 3.5/4.0.'
  },
  {
    id: 'prog-ai-ms',
    title: 'M.S. Artificial Intelligence & Neural Networks',
    ...
    format: 'Full-time On Campus',
    featured: true,
    description: 'Advanced graduate program delving into generative AI, transformer models, reinforcement learning, computer vision, and autonomous robotics ethics.',
    ...
    prerequisites: 'Bachelor degree in Computer Science, Applied Math, or Electrical Engineering. GRE Quantitative score 165+.'
  },
  {
    id: 'prog-mba-exec',
    title: 'Executive MBA in Global Leadership & Strategy',
    universityId: 'uni-business',
    universityName: 'Global Business & Economics Academy',
    degreeLevel: 'Postgraduate',
    category: 'Business & Management',
    duration: '1.5 Years (Intensive)',
    credits: 52,
    tuitionPerYear: 36000,
    applicationDeadline: 'Rolling Admissions',
    format: 'Hybrid',
    featured: true,
    description: 'Designed for high-potential executives seeking to master corporate finance, digital business transformation, global supply chains, and venture leadership.',
    ...
    prerequisites: 'Minimum 5 years of professional management experience and undergraduate degree.'
  },
  {
    id: 'prog-med-md',
    ...
    format: 'Full-time On Campus',
    featured: true,
    description: 'Comprehensive medical training combining pre-clinical biomedical sciences with 2 full years of clinical hospital rotations in surgery, pediatrics, and emergency care.',
    curriculumHighlights: ['Human Gross Anatomy & Histology', 'Pathophysiology & Pharmacology', 'Clinical Skills & Diagnostics', 'Surgical & Emergency Medicine Rotations'],
    careerOutcomes: ['Attending Physician', 'Surgeon', 'Medical Researcher', 'Clinical Director'],
    prerequisites: 'Pre-Med Bachelor Degree, MCAT Score 512+, 200+ hours of clinical shadow experience.'
  },
  {
    id: 'prog-law-jd',
    title: 'Juris Doctor (J.D.) in Constitutional & Tech Law',
    ...
    format: 'Full-time On Campus',
    featured: false,
    description: 'Equipping future attorneys to advocate in federal courts, draft emerging cyber legislation, and master corporate law, intellectual property, and civil rights.',
    curriculumHighlights: ['Constitutional Law', 'Intellectual Property & AI Regulation', 'Federal Appellate Advocacy', 'International Trade & Human Rights'],
    careerOutcomes: ['Trial Attorney', 'Judicial Law Clerk', 'Corporate General Counsel', 'Legislative Policy Advisor'],
    prerequisites: 'Undergraduate degree in any discipline. LSAT Score 164+ or GRE Equivalent.'
  },
  {
    id: 'prog-vfx-bfa',
    title: 'B.F.A. Interactive Media, VFX & Game Design',
    ...
    format: 'Full-time On Campus',
    featured: false,
    description: 'Unleash artistic vision with 3D animation pipelines, Unreal Engine 5 real-time graphics, character design, spatial audio, and cinematic visual effects.',
    curriculumHighlights: ['3D Modeling & Sculpting', 'Unreal Engine 5 Real-Time Production', 'Character Animation & Rigging', 'Virtual Production & Motion Capture'],
    careerOutcomes: ['Lead 3D Artist', 'VFX Supervisor', 'Unreal Technical Director', 'Concept Artist'],
    prerequisites: 'High School Diploma + Creative Art & Portfolio Submission (10-15 original pieces).'
  },
  {
    id: 'prog-fintech-msc',
    title: 'M.Sc. Financial Technology & Quantitative Risk',
    universityId: 'uni-business',
    universityName: 'Global Business & Economics Academy',
    degreeLevel: 'Postgraduate',
    category: 'Business & Management',
    ...
    format: 'Full-time On Campus',
    featured: false,
    description: 'Master algorithmic trading, blockchain protocols, machine learning risk models, and quantitative asset pricing on live trading floors.',
    ...
    careerOutcomes: ['Quantitative Analyst (Quant)', 'FinTech Product Lead', 'Risk Risk Manager', 'Algorithmic Trader'],
    prerequisites: 'Degree in Finance, Math, Physics, CS, or Economics with strong quantitative background.'
  },
  {
    id: 'prog-biotech-msc',
    title: 'M.Sc. Molecular Biotechnology & Gene Editing',
    universityId: 'uni-heritage',
    universityName: 'Heritage State University',
    degreeLevel: 'Postgraduate',
    ...
    format: 'Full-time On Campus',
    featured: false,
    description: 'Hands-on research with CRISPR gene therapy, synthetic biology, biopharmaceutical manufacturing, and clinical trial design in cutting-edge cleanrooms.',
    ...
    prerequisites: 'Bachelor in Biology, Biochemistry, or Bioengineering with minimum 3.2 GPA.'
  }
];
...
export const INITIAL_APPLICATIONS = [
  {
    ...
    universityName: 'Heritage State University',
    programTitle: 'B.Sc. Computer Science & Software Engineering',
    degreeLevel: 'Undergraduate',
    gpa: '3.92',
    status: 'Accepted' as const,
    appliedDate: '2026-06-12',
    documentsUploaded: ['High School Transcript.pdf', 'SAT Scores (1520).pdf', 'Statement of Purpose.pdf', 'Recommendation Letter.pdf'],
    notes: 'Accepted with Merit Dean Scholarship ($10,000/yr).'
  },
  {
    id: 'ADM-2026-9120',
    ...
    universityName: 'Veritas Institute of Technology',
    programTitle: 'M.S. Artificial Intelligence & Neural Networks',
    degreeLevel: 'Postgraduate',
    gpa: '3.85',
    status: 'Under Review' as const,
    appliedDate: '2026-07-04',
    documentsUploaded: ['B.S. Transcript.pdf', 'GRE Official Report.pdf', 'Research Proposal.pdf'],
  ...
  },
  {
    ...
    universityName: 'Global Business & Economics Academy',
    programTitle: 'Executive MBA in Global Leadership & Strategy',
    degreeLevel: 'Postgraduate',
    gpa: '3.70',
...
export const FAQS: FAQItem[] = [
  {
    id: 'faq-1',
    category: 'Admissions',
    question: 'How do I apply for undergraduate and postgraduate admissions through this portal?',
    answer: 'Select your target university or degree program from our directory, click "Apply Now", or go directly to the Admissions Portal navlink. You can fill in your academic profile, upload transcripts, and track your application in real-time using your tracking ID.'
  },
  {
    id: 'faq-2',
