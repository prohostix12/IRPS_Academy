...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#FAF6F6] text-neutral-900 flex flex-col font-sans selection:bg-[#7A0016] selection:text-white">
      
      {/* Toast Notification */}
      {notification && (
        <div className="fixed bottom-6 right-6 z-50 bg-[#7A0016] text-white px-5 py-3.5 rounded-2xl shadow-2xl border border-amber-300/40 flex items-center gap-3 animate-slideUp">
        ...
        {activeTab === 'home' && (
          <div>
            ...
            <UniversitiesSection
              ...
              onOpenQuickApplyWithUni={handleOpenQuickApplyWithUni}
            />
            ...
            <ProgramsSection
              ...
              onApplyToProgram={handleApplyToProgram}
            />
          </div>
        )}
